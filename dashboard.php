...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="height: 100%;">
    ...
    <section class="content-header">
      <h1 style="text-align:center;"> Master Timetable </h1>
      <ol class="breadcrumb">
...
include "database.php";
    ...
    ?>
                <form name="day" method="post" action="" id="print-btn">
...
$row=mysqli_fetch_array($querytt);
 ...
 if($row['type']==1)
                             { echo "<b>Teacher: </b>".$row['tname']."<br><b>Sub: </b>".$row['sname']."<br>";
                                ...
                                ?>
                               <a href='deletett.php?srno=<?php echo $row['srno']; ?>' class="btn btn-danger" id="print-btn">Delete</a>
                                
                               <a href='addttdemo.php ?>' class="btn btn-primary" id="print-btn">Update</a>
